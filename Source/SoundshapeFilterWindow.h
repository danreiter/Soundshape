...
/*
  ==============================================================================
   ...
   ORIGINAL FILE IS PART OF THE JUCE LIBRARY
...
/*
 Modified 2019 by Mardigon Toler as part of Soundshape
*/
...
namespace juce {
    ...
    /**
        ...
        This class was adapted from the JUCE library file
        juce_StandaloneFilterWindow.h

        Modifications have been made for things like 
        prevent saving/loading state on startup/shutdown.
        ...
        @tags{Audio}
    */
    class SoundshapePluginHolder : private AudioIODeviceCallback,
        private Timer
    {
    public:
        //==============================================================================
        ...
        */
        SoundshapePluginHolder(PropertySet* settingsToUse,
        ...
        void init(bool enableAudioInput, const String& preferredDefaultDeviceName)
        {
            ...
            // we dont to load a state one init in Standalone mode
        ...
        virtual ~SoundshapePluginHolder()
        {
            stopTimer();
        ...
        static SoundshapePluginHolder* getInstance();
    ...
    private:
        ...
        {
        public:
            SettingsComponent(SoundshapePluginHolder& pluginHolder,
        ...
        JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(SoundshapePluginHolder)
    };
    ...
    /**
        ...
        @tags{Audio}
    */
    class SoundshapeFilterWindow : public DocumentWindow,
        public Button::Listener
    {
    public:
        //==============================================================================
        typedef SoundshapePluginHolder::PluginInOuts PluginInOuts;
        ...
        */
        SoundshapeFilterWindow(const String& title,
            ...
            optionsButton("Options")
        {
            ...
            pluginHolder.reset(new SoundshapePluginHolder(settingsToUse, takeOwnershipOfSettings,
        ...
        {
            // In standalone mode, we don't want the 
            // state to be saved when shutting down.
        ...
        static void menuCallback(int result, SoundshapeFilterWindow* button)
        {
        ...
        virtual SoundshapePluginHolder* getPluginHolder() { return pluginHolder.get(); }

        std::unique_ptr<SoundshapePluginHolder> pluginHolder;
    ...
    private:
        ...
        {
        public:
            MainContentComponent(SoundshapeFilterWindow& filterWindow)
        ...
        JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(SoundshapeFilterWindow)
    };

    inline SoundshapePluginHolder* SoundshapePluginHolder::getInstance()
    {
        ...
        if (PluginHostType::getPluginLoadedAs() == AudioProcessor::wrapperType_Standalone)
        {
            ...
            for (int i = 0; i < numTopLevelWindows; ++i)
                if (auto window = dynamic_cast<SoundshapeFilterWindow*> (desktop.getComponent(i)))
